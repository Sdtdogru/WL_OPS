...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            ...
            html.push(
                    ...
                    sprintf('<form autocomplete="off" class="custom_datatables_search_form"><input class="form-control' +
                            sprintf(' input-%s', this.options.iconSize) +
                            '" type="text" placeholder="%s"></form>',
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        // Assign the correct sortable arrow
        this.getCaret();
        this.$tableContainer.css('padding-bottom', (padding + 5) + 'px');
